defmodule AbsinthePhoenixExampleWeb.Middleware.ChangesetErrors do
  @moduledoc """
  ...
  import AbsinthePhoenixExampleWeb.Helper.Utils, only: [handle_absinthe_error: 2]

  alias AbsinthePhoenixExampleWeb.Gettext, as: Translator
